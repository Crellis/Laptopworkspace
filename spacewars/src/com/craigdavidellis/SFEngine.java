...
public class SFEngine {
	...
	public static final int GAME_THREAD_DELAY = 4000; /*Delay the spawning of the game thread 4 secs*/
	public static final int MENU_BUTTON_ALPHA = 0;
	public static final boolean HAPTIC_BUTTON_FEEDBACK = true; /*Haptic feedback is the response few certain devices can give when you touch buttons. */
	public static final int SPLASH_SCREEN_MUSIC = R.raw.spacewars;
	public static final int R_VOLUME = 100; /** Volume from right speaker */
	public static final int L_VOLUME = 100; /** Volume from left speaker */
	public static final boolean LOOP_BACKGROUND_MUSIC = true; /** Loop the background music */
	...
	public static int CHARACTER_SHEET = R.drawable.charactersprite;
	...
	public static final int PLAYER_SHIELDS = 7;
	public static final int SCOUT_SHIELDS = 5;
	public static final int INTERCEPTOR_SHIELDS = 3;
	public static final int WARSHIP_SHIELDS = 5;
	public static final float PLAYER_BULLET_SPEED = .050f;
