...
public class ProductAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.catalog, null);
			item = new ViewItem();
			
			item.productImageView = (ImageView) convertView
			.findViewById(R.id.ListViewCatalog);
			
			item.productTitle = (TextView) convertView.findViewById(R.id.TextView01);
			
			item.productCheckbox = (CheckBox) convertView.findViewById(R.id.ButtonViewCart);
