...
public class GameThread extends Thread{
	...
	/*
	 * Restore/save state (do not confuse with mMode states) of a game, i.e. all needed variable. 
	 * Doing this and we can pause the game and recieve calls.
	 */
	...
	protected void updatePhysics() {
		...
		if(mBallY <= 0) setState(GameThread.STATE_LOSE);
		if(mBallY >= mCanvasHeight - mBall.getHeight()) setState(GameThread.STATE_WIN);
